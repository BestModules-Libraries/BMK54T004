...
Others:  none     
**********************************************************/
void BMK54T004::setLedMode(uint8_t mode)
{
  if(mode <= 1)
  {
...
Others:  none     
**********************************************************/
void BMK54T004::writeLed(uint16_t data)
{
